...
public class Level_23_GRID extends BaseTest {
	...
	@Parameters({ "browser", "enviroment", "osName", "ipAddress", "port" })
	@BeforeClass
	public void beforeClass(String browserName, String enviromentName, String osName, String ipAddress, String portNumber) {
		ConfigFactory.setProperty("env", enviromentName);
		enviroments = ConfigFactory.create(Enviroments.class);
		driver = getBrowserDriverGRID(browserName, enviroments.appUrl(), osName, ipAddress,portNumber );
